...
\section*{Synopsis}
Dark matter haloes are the fundamental building blocks of the large scale structure in the Lambda-cold dark matter ($\Lambda$CDM) picture of the Universe. Made of non-luminous matter, they make the gravitational wells for the
...
In the , the primary environment of any galaxy is provided by a `halo' of dark matter surrounding it \citep[e.g.,][]{wr78}. 
