...
\end{align}
where $\xi \equiv \ln \tau $ with $ \tau \equiv t/t_{\smallfrown}$ and $t_{\smallfrown}$ being the turnaround time of that shell \cite{1985ApJS...58...39B,2016ShiICM}. 
...
\end{align}
In the absence of shell-crossing for collision gas, the evolution of velocity profiles along with the density, pressure and mass profiles is given by the spherical hydrodynamical equations \cite{1985ApJS...58...39B} as
\begin{align}
...
For such a self-similarly propagating shock, the jump conditions \cite{1985ApJS...58...39B} expressed in terms of the dimensionless self-similar quantities are 
\begin{eqnarray}
...
Usually, this shock radius $(\lambda_{\rm s})$ is fine-tuned such that gas shells accrete all the way to the center but sufficiently slow to halt at $\lambda=0$ preventing the formation of a black hole \cite{1985ApJS...58...39B}. In our model, we break this adiabaticity by allowing the gas to cool and further form a galaxy-like structure as described in the following sections.
