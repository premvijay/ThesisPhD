...
This chapter is organised as follows. We outline the self-similar model of dark matter halo collapse in \secref{sec:methods-dm-ch:ssr}. This is followed by a description of our new self-similar galaxy formation model in an EdS universe in \secref{sec:methods-gas-ch:ssr}. Then, we discuss the solutions to our self-similar galaxy formation model in \secref{sec:results-gaso-ch:ssr}. Following this we present the self-similar solutions in our model of co-evolving dark matter halo and gas accretion onto galaxy in \secref{sec:results-gas-dm-coevolve-ch:ssr}. In this section, we discuss the relaxation response of dark matter halo in this self-similar setting and compare against the results from simulations and we conclude in \secref{sec:conclusion-ch:ssr}.
