...
Extending on those workd, Bertschinger (1989) \cite{1989Bertschinger} also studied self-similar cooling flows of gas, but focusing on the inner regions of galaxies. In contrast, Owen et al. (1998) \cite{1998OwenWeinberg_etal} derived a set of cooling functions that guarantee self-similar evolution by ensuring that the cooling time-scale of an object with a characteristic clustering mass remains a constant fraction of the Hubble time. Abadi et al. (2000) \cite{2000Abadi_etal_SelfSimCool} studied the self-similar accretion of gas with radiative cooling in the EdS Universe.
