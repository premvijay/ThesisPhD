...
\begin{frame}{List of Publications}
    ...
    % \end{itemize}
\noindent
1. Velmani \& Paranjape, 2023, ``The quasi-adiabatic relaxation of haloes in the IllustrisTNG and EAGLE cosmological simulations", \textit{MNRAS}, 
...
\noindent
2. Velmani \& Paranjape, 2024, ``A self-similar model of galaxy formation and dark halo relaxation", \textit{JCAP}, 
% \textbf{2024}(5):080. 
...
\noindent
3. Velmani \& Paranjape, 2025,``Dynamics of the response of dark matter halo to galaxy evolution in IllustrisTNG", \textit{JCAP},
...
\noindent
4. Velmani \& Paranjape, 2024,``Role of astrophysical modeling on dark matter halo relaxation response at redshifts z = 0 and z = 1", \href{https://arxiv.org/abs/2408.04864}{arXiv:2408.04864}, \textit{JCAP subm.}
...
\begin{frame}{Relaxation relation in IllustrisTNG}
    \begin{columns}
        \begin{column}{.59\linewidth}
            ...
            \includegraphics[width=0.5\linewidth]{plots/Mass_bin_labels.pdf}
        \end{column}
...
\begin{frame}
    \includegraphics[width=.4\linewidth]{plots/fit_param_q3s_M_TE.pdf}
\end{frame}
